...
namespace unicatalog
{
    internal static class Program
    {
        ...
        static void CreateTable(SQLiteConnection conn)
        {
            ...
            string cont = "CREATE TABLE CONT (ID INT, NUME VARCHAR(20), PAROLA VARCHAR(20), TIP VARCHAR(20))";
        ...
        static void InsertData(SQLiteConnection conn)
        {
            ...
            sqlite_cmd.CommandText = "INSERT INTO PROFESOR (ID, NUME) VALUES(1, 'MIHAI'); ";
            sqlite_cmd.ExecuteNonQuery();

            sqlite_cmd.CommandText = "INSERT INTO PROFESOR (ID, NUME) VALUES(1, 'ION'); ";
            sqlite_cmd.ExecuteNonQuery();

            sqlite_cmd.CommandText = "INSERT INTO PROFESOR (ID, NUME) VALUES(1, 'GITA'); ";
            sqlite_cmd.ExecuteNonQuery();
            //sqlite_cmd.CommandText = "INSERT INTO CONT (ID, NUME, PAROLA, TIP) VALUES(1, 'ADMIN', 'ADMIN','1'); ";
            //sqlite_cmd.ExecuteNonQuery();
            ...
            sqlite_cmd.CommandText = "INSERT INTO STUDENT (ID, NUME, PRENUME) VALUES(1, 'MIHAI', 'MIHAI'); ";
            sqlite_cmd.ExecuteNonQuery();

            sqlite_cmd.CommandText = "INSERT INTO STUDENT (ID, NUME, PRENUME) VALUES(1, 'GABI', 'MIHAI'); ";
            sqlite_cmd.ExecuteNonQuery();

            sqlite_cmd.CommandText = "INSERT INTO STUDENT (ID, NUME, PRENUME) VALUES(1, 'ELENA', 'MIHAI'); ";
            sqlite_cmd.ExecuteNonQuery();
        ...
        static void ReadData(SQLiteConnection conn)
        {
            ...
            SQLiteCommand sqlite_cmd;
            sqlite_cmd = conn.CreateCommand();
            sqlite_cmd.CommandText = "SELECT NUME FROM STUDENT";
